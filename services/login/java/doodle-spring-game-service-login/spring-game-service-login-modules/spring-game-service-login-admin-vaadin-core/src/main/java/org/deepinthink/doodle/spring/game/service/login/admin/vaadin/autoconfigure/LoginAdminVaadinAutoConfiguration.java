...
@AutoConfiguration
@EnableVaadin(LoginAdminVaadinProperties.PREFIX_VIEWS)
@EnableConfigurationProperties(LoginAdminVaadinProperties.class)
public class LoginAdminVaadinAutoConfiguration {

  @Bean
  public VaadinAdminSideNavItemSupplier loginAdminVaadinSideNavView(
      LoginAdminVaadinProperties properties) {
