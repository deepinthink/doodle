...
public class SpringGameEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
  ...
  public static final String SPRING_GAME_DEFAULT_PROPERTY_SOURCE =
      "doodle.spring-game.default-properties";
  public static final String SPRING_GAME_VERSION = "doodle.spring-game.version";
  public static final String SPRING_GAME_FORMATTED_VERSION = "doodle.spring-game.formatted-version";
